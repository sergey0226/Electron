                    ...
                    <Grid container direction="row">
                        ...
                        <Grid item xs={6} justify="center">
                            <Typography variant="h4" color="primary" align="center">
                                {language === 'Japanese' ? '選手情報' : 'TRAINING SESSION'}
                            </Typography>
                        </Grid>
                    </Grid>
                    <Grid container direction="row">
          ...
          >
            <Grid xs={3}>
                <Typography variant="h6" color="primary" align="center">
                    {language === 'Japanese' ? '選手情報' : 'Main Topic Methodology'}
                </Typography>
            </Grid> 
            <Grid xs={9} direction="column" style={{ borderLeftStyle:'solid' }}>
                {this.renderSelectTextField(1, 2, 'Minute')}
                {this.renderSelectTextField(1, 2, 'Minute')}
                {this.renderSelectTextField(1, 2, 'Minute')}
                {this.renderSelectTextField(1, 2, 'Minute')}
                ...
                <TextField
                    ...
                    fullWidth
                    id="outlined-multiline-flexible"
                    placeholder={language === 'Japanese' ? 'コメント' : 'Comments'}
                    margin="dense"
                    variant="outlined"
                />
            </Grid> 
          ...
          >
            <Grid xs={6} direction="row">
                ...
                <Grid>
                    <input
                        ...
                        multiple
                        type="file"
                        onChange={this.handleImageChange('firstImage')}
                    />
            ...
            <Grid xs={6}>
                <input
                    ...
                    multiple
                    type="file"
                    onChange={this.handleImageChange('secondImage')}
                />
