...
const scores = [...fieldsArray.technicalScores];
      ...
      <Bar
        ...
        data={{
          labels:
            language === 'English'
              ? [...scores].slice(0, 20)
              : [...fieldsArrayJap.technicalScores].slice(0, 20),
          datasets: [
            {
              label: language === 'Japanese' ? '攻撃' : 'Attacking',
              backgroundColor: 'rgba(75,192,192,1)',
              data: [
                playerInformation['ShortPassing' + `${attackNo}`]
                  ? parseInt(playerInformation['ShortPassing' + `${attackNo}`])
                  : 0,
                playerInformation['LongPassing' + `${attackNo}`]
                  ? parseInt(playerInformation['LongPassing' + `${attackNo}`])
                  : 0,
                playerInformation['Dribbling' + `${attackNo}`]
                  ? parseInt(playerInformation['Dribbling' + `${attackNo}`])
                  : 0,
                playerInformation['Turning' + `${attackNo}`]
                  ? parseInt(playerInformation['Turning' + `${attackNo}`])
                  : 0,
                playerInformation['Shooting' + `${attackNo}`]
                  ? parseInt(playerInformation['Shooting' + `${attackNo}`])
                  : 0,
                playerInformation['BallControl' + `${attackNo}`]
                  ? parseInt(playerInformation['BallControl' + `${attackNo}`])
                  : 0,
                playerInformation['FirstTouch' + `${attackNo}`]
                  ? parseInt(playerInformation['FirstTouch' + `${attackNo}`])
                  : 0,
                playerInformation['Heading' + `${attackNo}`]
                  ? parseInt(playerInformation['Heading' + `${attackNo}`])
                  : 0,
                playerInformation['OnevOne' + `${attackNo}`]
                  ? parseInt(playerInformation['OnevOne' + `${attackNo}`])
                  : 0,
                playerInformation['Keepingtheball' + `${attackNo}`]
                  ? parseInt(
                      playerInformation['Keepingtheball' + `${attackNo}`]
                    )
                  : 0,
                playerInformation['Receiving' + `${attackNo}`]
                  ? parseInt(playerInformation['Receiving' + `${attackNo}`])
                  : 0,
                playerInformation['Crossing' + `${attackNo}`]
                  ? parseInt(playerInformation['Crossing' + `${attackNo}`])
                  : 0,
                playerInformation['Finishing' + `${attackNo}`]
                  ? parseInt(playerInformation['Finishing' + `${attackNo}`])
                  : 0,
                playerInformation['Support' + `${attackNo}`]
                  ? parseInt(playerInformation['Support' + `${attackNo}`])
                  : 0,
                playerInformation['Sidechangepassing' + `${attackNo}`]
                  ? parseInt(
                      playerInformation['Sidechangepassing' + `${attackNo}`]
                    )
                  : 0,
                playerInformation['Vole' + `${attackNo}`]
                  ? parseInt(playerInformation['Vole' + `${attackNo}`])
                  : 0,
                playerInformation['Feint' + `${attackNo}`]
                  ? parseInt(playerInformation['Feint' + `${attackNo}`])
                  : 0,
                playerInformation['Thirdman' + `${attackNo}`]
                  ? parseInt(playerInformation['Thirdman' + `${attackNo}`])
                  : 0,
                playerInformation['Passandgo' + `${attackNo}`]
                  ? parseInt(playerInformation['Passandgo' + `${attackNo}`])
                  : 0,
                playerInformation['Throughpass' + `${attackNo}`]
                  ? parseInt(playerInformation['Throughpass' + `${attackNo}`])
                  : 0
              ]
            }
          ]
      ...
      <Bar
        ...
        data={{
          labels:
            language === 'English'
              ? [...scores].slice(20, 40)
              : [...fieldsArrayJap.technicalScores].slice(20, 40),
          datasets: [
            {
              ...
              data: [
                playerInformation['OnevOne' + `${attackNo}`]
                  ? parseInt(playerInformation['OnevOne' + `${attackNo}`])
                  : 0,
                playerInformation['BodyShape' + `${attackNo}`]
                  ? parseInt(playerInformation['BodyShape' + `${attackNo}`])
                  : 0,
                playerInformation['Anticipation' + `${attackNo}`]
                  ? parseInt(playerInformation['Anticipation' + `${attackNo}`])
                  : 0,
                playerInformation['Intercepting' + `${attackNo}`]
                  ? parseInt(playerInformation['Intercepting' + `${attackNo}`])
                  : 0,
                playerInformation['Tackling' + `${attackNo}`]
                  ? parseInt(playerInformation['Tackling' + `${attackNo}`])
                  : 0,
                playerInformation['Aproaching' + `${attackNo}`]
                  ? parseInt(playerInformation['Aproaching' + `${attackNo}`])
                  : 0,
                playerInformation['Covering' + `${attackNo}`]
                  ? parseInt(playerInformation['Covering' + `${attackNo}`])
                  : 0,
                playerInformation['Backstep' + `${attackNo}`]
                  ? parseInt(playerInformation['Backstep' + `${attackNo}`])
                  : 0,
                playerInformation['Sidestep' + `${attackNo}`]
                  ? parseInt(playerInformation['Sidestep' + `${attackNo}`])
                  : 0,
                playerInformation['Postioning' + `${attackNo}`]
                  ? parseInt(playerInformation['Postioning' + `${attackNo}`])
                  : 0,
                playerInformation['Backpress' + `${attackNo}`]
                  ? parseInt(playerInformation['Backpress' + `${attackNo}`])
                  : 0,
                ...
                playerInformation['Heading' + `${attackNo}`]
                  ? parseInt(playerInformation['Heading' + `${attackNo}`])
                  : 0,
                playerInformation['Clearing' + `${attackNo}`]
                  ? parseInt(playerInformation['Clearing' + `${attackNo}`])
                  : 0,
                playerInformation['BodyContact' + `${attackNo}`]
                  ? parseInt(playerInformation['BodyContact' + `${attackNo}`])
                  : 0,
                playerInformation['Diagonalbackrunning' + `${attackNo}`]
                  ? parseInt(
                      playerInformation['Diagonalbackrunning' + `${attackNo}`]
                    )
                  : 0,
                playerInformation['Shielding' + `${attackNo}`]
                  ? parseInt(playerInformation['Shielding' + `${attackNo}`])
                  : 0,
                playerInformation['Timing' + `${attackNo}`]
                  ? parseInt(playerInformation['Timing' + `${attackNo}`])
                  : 0
              ]
            }
          ]
      ...
      <div className={classes.root} id="divToPrint" ref={bodyRef}>
        <div className={classes.innerRoot} elevation={1}>
          <Typography variant="h6" color="primary">
            {language === 'Japanese' ? '技術' : 'Technical'}
          </Typography>
          <br />
          <Toolbar>
          ...
          <div>
            ...
            <Typography className={classes.commentTypo} variant="subtitle2">
              {language === 'Japanese'
                ? '技術状況について'
                : 'INFORMATION ABOUT TECHNICAL STATUS'}
            </Typography>
            <Grid
              container
              spacing={0}
            ...
            >
              <Grid item xs container justify="center">
                <TextField
                  ...
                  value={
                    playerInformation &&
                    (playerInformation.TechnicalStatus
                      ? playerInformation.TechnicalStatus
                      : '')
                  }
                  onChange={this.handleFieldChange('Technical Status')}
                  multiline
                  rows="4"
                  rowsMax="4"
                  margin="dense"
              ...
              <Grid item xs={2} container justify="center">
                ...
                {scores.slice(0, 20).map((title, index) => {
                  const label =
                    language === 'English'
                      ? title
                      : fieldsArrayJap.technicalScores[index];
                  return (
              ...
              <Grid item xs={2} container justify="center">
                ...
                {scores.slice(20, 40).map((title, index) => {
                  const label =
                    language === 'English'
                      ? title
                      : fieldsArrayJap.technicalScores[index + 20];
                  return (
                    <div key={index} style={{ width: '100%', margin: 12.5 }}>
                      <Typography
                        style={{ fontSize: 12 }}
